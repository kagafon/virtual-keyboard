...
export default {
  ...
  ControlLeft: (code,
    keyboard,
    displayValues,
    className) => new ControlButton(code, keyboard, displayValues, className, 'lctrl'),
  ControlRight: (code,
    keyboard,
    displayValues,
    className) => new ControlButton(code, keyboard, displayValues, className, 'rctrl'),
  ShiftLeft: (code,
    keyboard,
    displayValues,
    className) => new ShiftButton(code, keyboard, displayValues, className, 'lshift'),
  ShiftRight: (code,
    keyboard,
    displayValues,
    className) => new ShiftButton(code, keyboard, displayValues, className, 'rshift'),
  CapsLock: (code,
    keyboard,
    displayValues,
